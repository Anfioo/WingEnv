...
def button_choice_dialogs_test():
...
def test_single_select():
    ...
    result = select_single_option_ui(
        config=config,
...
def test_multi_select():
    ...
    result = select_multiple_options_ui(
        config=config,
...
def run_test_progress_bar(test_bar_name):
